...
import { Calendar, User, Home, Clock, Plus, AlertCircle } from "lucide-react";

const statusConfig = {
  Confirmed: { bg: "bg-green-500/20", border: "border-green-500/50", text: "text-green-300" },
  Pending: { bg: "bg-yellow-500/20", border: "border-yellow-500/50", text: "text-yellow-300" },
  "Checked-in": { bg: "bg-blue-500/20", border: "border-blue-500/50", text: "text-blue-300" }
};
    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4 py-8">
        ...
        >
          ...
          />
          <p className="text-center text-slate-300 mt-4">Loading bookings...</p>
        </motion.div>
      </div>
    );
  }
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="text-slate-400">
                Manage your upcoming check-ins and live stays
              </p>
            </div>
            <motion.button
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-300">Unable to load bookings: {error}</p>
              </div>
            </div>
          </motion.div>
        )}
                ...
                <table className="w-full">
                  ...
                  <tbody>
                    {bookings.map((booking, index) => {
                      ...
                      return (
                        <motion.tr
                          key={`${booking.guest}-${booking.room}-${index}`}
